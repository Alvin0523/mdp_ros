...
| `mdp_bridge` | STM32 serial bridge (`serial_bridge_node`) + Android Bluetooth bridge (`bluetooth_bridge_node`: obstacles, start/stop, manual drive, pose/status to the tablet) |
